...
public class RestController2 {
    // 100을 반환하는 메소드
    @GetMapping("/day2/task")   // was(톰캣)주소/내가정의한주소, localhost::8080/day2/task
    ...
    @GetMapping("/day2/task4") @ResponseBody    // java boolean -> application/json
    public boolean method4(){
        return true;
    }
    // 5. DTO 타입 반환 하는 메소드
    @GetMapping("/day2/task5") @ResponseBody

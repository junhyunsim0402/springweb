...
function FrontComp( props ){ // props는 함수/컴포넌트 의 매개변수이며 프롭스 객체이다.
    console.log( props );
    // {propData1: Array(4), frTitle: '프론트엔드'}
    const liRows = [ ]; // 배열선언 
...
const BackComp = ( { propData2 , baTitle } ) =>{
    ...
    // 즉] 객체내 값들을 각 변수로 분해 , a속성 b속성 으로 구성된 객체를 a변수 b변수로 분해한다.
...
function Exam1(){
    ...
    return(<> 
        <h3> props 객체 p.90 </h3>
        <MyComponent p1={ "HTML"} p2="CSS" p3={ 'Javascrpt' } p4={ "jQuery"} />
        <MyComponent2 p1={ "HTML"} p2="CSS" p3={ 'Javascrpt' } p4={ "jQuery"} />
